...
public class AtlasDbConstants {
    ...
    public static final String DBKVS_UPGRADE_TABLE = "atlasdb_dbkvs_upgrades";
    public static final String DBKVS_NAME_MAPPING_TABLE = "atlasdb_table_names";
    public static final String ORACLE_NAME_MAPPING_PK_CONSTRAINT = "pk_" + DBKVS_NAME_MAPPING_TABLE;
